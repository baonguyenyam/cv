...
var topRightX_1;
var bottomLeftX_1;
var bottomRightX_1; ///Animation Variables
...
var currentFrame_1 = 1; ///Menu Disappear
...
function menuDisappearAnimation_1() {
  ...
  if (currentFrame_1 <= menuDisappearDurationInFrames_1) {
    window.requestAnimationFrame(function () {
      ...
      topLine_1.setAttribute("d", "M30," + topLineY_1 + " L70," + topLineY_1); //bottom line

      bottomLineY_1 = AJS.easeInBack(63, 50, menuDisappearDurationInFrames_1, currentFrame_1);
      bottomLine_1.setAttribute("d", "M30," + bottomLineY_1 + " L70," + bottomLineY_1); //recursion
...
function arrowAppearAnimation_1() {
  ...
  if (currentFrame_1 <= arrowAppearDurationInFrames_1) {
    window.requestAnimationFrame(function () {
      ...
      topLine_1.setAttribute("d", "M" + topLeftX_1 + "," + topLeftY_1 + " L" + bottomRightX_1 + "," + bottomRightY_1); //bottom line
      ...
      bottomLine_1.setAttribute("d", "M" + bottomLeftX_1 + "," + bottomLeftY_1 + " L" + topRightX_1 + "," + topRightY_1); //recursion
...
$(document).ready(function () {
  ...
  LIFT_CHAT_APP.jsonLoad('https://api.github.com/users/baonguyenyam', function (data) {
